...
public class Controller {
    ...
    public void initialize() {
        ...
        // ✅ Implement ChangeListener for the slider (Snaps to 12-month intervals)
    ...
    private void calculatePayment() {
        try {
            ...
            double months = sldLoanPeriod.getValue();
            ...
            switch (frequency) {
                case "Monthly":
                    payment = calculateLoan(principal, annualRate / 12 / 100, (int) months);
                    break;
                case "Bi-Weekly":
                    payment = calculateLoan(principal, annualRate / 26 / 100, (int) (months / 12.0 * 26));
                    break;
                case "Weekly":
                    payment = calculateLoan(principal, annualRate / 52 / 100, (int) (months / 12.0 * 52));
                    break;
            }
